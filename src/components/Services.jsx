      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="card p-6 sr d1">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv1t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv1d')}</p>
          ...
          <div className="card p-6 sr d2">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv2t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv2d')}</p>
            <div className="flex flex-wrap gap-1.5">
          ...
          <div className="card p-6 sr d3">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv3t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv3d')}</p>
            <div className="flex flex-wrap gap-1.5">
              <span className="tag tag-py">Python</span>
          ...
          <div className="card p-6 sr d4">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv4t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv4d')}</p>
            <div className="flex flex-wrap gap-1.5">
          ...
          <div className="card p-6 sr d5">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv5t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv5d')}</p>
            <div className="flex flex-wrap gap-1.5">
              <span className="tag tag-py">Python</span>
          ...
          <div className="card p-6 sr d6">
            ...
            <h3 className="font-heading font-bold text-text mb-2">{t('serv6t')}</h3>
            <p className="text-muted text-sm leading-relaxed mb-3">{t('serv6d')}</p>
            <div className="flex flex-wrap gap-1.5">
